...
Работа может быть реализована 2-мя способами: с использованием удалённого сервера по адресу "https://bhj-diplom.letsdocode.ru" или развёрнутым локально по адресу "http://localhost:8000". Описание серверной логики можете найти в [файле](./md/server.md)
