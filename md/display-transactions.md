...
Принимает один аргумент *options* - объект с настройками вида:

```json
{
  "account_id": "23" // идентификатор счёта
}
```
...
В метод передаётся объект *item* следующего формата:

```json
{
  "id": 12,
  "type": "expense", // "expense" или "income" (доход или расход)
  "name": "Новый будильник",
  "date": "2019-03-10 00:20:41",
  "sum": 200, // 200 рублей трат
}
```
